...
output paths, accepted context docs, and task assembly. If instructions conflict, follow this prompt
without relaxing consolidation, traceability, reporting, or path-formatting rules.
...
- Reconciliation context, only if needed: accepted context docs listed in workflow or cited by
  source reports
...
4. For disagreements or cited context, read only accepted/cited context needed to reconcile.
