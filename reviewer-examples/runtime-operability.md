...
`storage-engine-facade/service/docs/feature-sync-meter-mapping-data/review/reports/04-runtime-operability.md`
...
- `storage-engine-facade/service/src/main/java/com/arvato/smartenergy/storageengine/controller/MasterDataChangesConsumer.java`
- `storage-engine-facade/service/src/main/java/com/arvato/smartenergy/storageengine/config/MasterDataChangesConsumerConfig.java`
- `storage-engine-facade/service/src/main/java/com/arvato/smartenergy/storageengine/config/MasterDataChangesStartupValidation.java`
- `storage-engine-facade/service/src/main/java/com/arvato/smartenergy/storageengine/service/MasterDataChangeLogFormatter.java`
- `storage-engine-facade/service/src/main/java/com/arvato/smartenergy/storageengine/service/MasterDataChangeLogContext.java`
- `storage-engine-facade/service/src/main/java/com/arvato/smartenergy/storageengine/service/KafkaRecordMetadata.java`
- `storage-engine-facade/service/src/main/resources/application.properties`
- `storage-engine-facade/service/src/main/helm/templates/configMap.yaml`
- `storage-engine-facade/service/src/main/helm/values.yaml`
