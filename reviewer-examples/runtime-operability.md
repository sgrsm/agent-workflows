...
`docs/features/example-event-sync/review/reports/04-runtime-operability.md`
...
- `docs/features/example-event-sync/specification/03-implementation-and-configuration.md`
  ...
  - `10.2 External Lookup Properties` — only where startup validation and packaged-default caveat affect operability
  - `10.3 External Lookup Helm Values`
...
- `src/main/java/com/example/app/controller/DomainChangesConsumer.java`
- `src/main/java/com/example/app/config/DomainChangesConsumerConfig.java`
- `src/main/java/com/example/app/config/DomainChangesStartupValidation.java`
- `src/main/java/com/example/app/service/DomainChangeLogFormatter.java`
- `src/main/java/com/example/app/service/DomainChangeLogContext.java`
- `src/main/java/com/example/app/service/RecordMetadata.java`
